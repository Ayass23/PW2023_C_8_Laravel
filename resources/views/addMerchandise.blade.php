                ...
                <div class="event-box">
                    ...
                    <script>
                        ...
                        if (namaMerchandise.trim() === "") {
                            ...
                            return false;
                        }else if (jenisMerchandise.trim() === "") {
                            alert("Jenis Merchandise Tidak Boleh Kosong!");
                            return false;
                        }else if (stokMerchandise.trim() === "") {
                            alert("Stok Merchandise Tidak Boleh Kosong!");
                            return false;
                        }else if (hargaMerchandise.trim() == "") {
                            alert("Harga Merchandise Tidak Boleh Kosong");
                            return false;
                        }else if (poster.trim() == "") {
                            alert("Silahkan Input Gambar Merchandise Anda!");
                            return false;
                        }else{
                            return true;
                        }
