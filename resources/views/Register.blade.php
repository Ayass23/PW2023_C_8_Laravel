                    ...
                    <div class= "card bg-glass" style="height: 100%;">
                        <div class="card-body px-4 py-5 px-md-5" style="height: 100%;">
                            <form class="form" action="{{ url('login') }}">
                                @csrf
                                <div>
                                    <h1 class="mb-3 text-center" style="font-weight: bold; color: Green">Register</h1>
                                </div>
                                ...
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="floatingInput" placeholder="Nomor Telepon" required/>
                                ...
                                <div style="display: flex; justify-content: center;">
                                    <button type="button" id="registerButton" style="width: 50%;" class="btn btn-success btn-block mb-2 mt-3" onclick="window.location='{{ url('login') }}'">
                                        Register
                                    </button>
                                </div>

                                <hr> 
                                    <p style="text-align: center;">Already Have account? <a href="{{ url('login') }}">Login</a></p>
                                </hr> 
