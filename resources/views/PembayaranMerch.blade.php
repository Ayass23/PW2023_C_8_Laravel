...
<head>
    ...
    <title>Pembayaran Merchandise</title>
                ...
                <div class="card shadow-lg">
                    <div class="container">
                        <div class="container text-center p-2" >
                            <h3 class="card-title text-success">Data Pemesanan Merchandise</h3>
                        </div>
                        <hr class="m-0">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer ">
              <button type="button" class="btn btn-outline-success" onclick="window.location='{{ url('merchandise') }}'">Done</button>
            </div>
          </div>
        </div>
    </div>
